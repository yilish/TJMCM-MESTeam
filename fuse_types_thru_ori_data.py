...
df_door.to_excel('classes_ori_data/GoalKeeper.xlsx')
df_striker.to_excel('classes_ori_data/Striker.xlsx')
df_midField.to_excel('classes_ori_data/MidField.xlsx')
df_guard.to_excel('classes_ori_data/Guard.xlsx')